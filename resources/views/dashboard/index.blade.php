...
<head>
    ...
    <!-- Bootstrap CSS -->
    <link href="{{asset('public/dashboard/css/bootstrap.rtl.min.css')}}" rel="stylesheet" />
    <!-- Google Fonts Cairo -->
    ...
    />
    <!-- Custom styles -->
    <link href="{{asset('public/dashboard/css/dashboard.rtl.css')}}" rel="stylesheet" />
</head>
<body>
@guest
    @if (Route::has('login'))
...
@else
    <header class="navbar navbar-dark flex-md-nowrap shadow">
        ...
        <div class="my-logo">
            ...
            ><img src="{{asset('public/dashboard/imgs/logo.svg')}}" width="110px" alt="logo"
                /></a>
        </div>
    </header>
    <!-- EXIT MODAL -->
            ...
            <nav id="sidebarMenu" class="d-md-flex sidebar collapse">
                    ...
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item">
                            <a id="tubes-link" class="nav-link" title="الإتصال">
                                ...
                                <span class="nav-link-name">الإتصال</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a id="store-link" class="nav-link" title="الإجتماع">
                        ...
                        <li class="nav-item">
                            <a id="admins-link" class="nav-link" title="المشرفين">
                                ...
                                <span class="nav-link-name">المشرفين</span>
                            </a>
                        </li>
                        ...
                        <li class="nav-item">
                            <a id="users-link" class="nav-link" title="الموظفين">
                                ...
                                <span class="nav-link-name">الموظفين</span>
                            </a>
                        </li>
                ...
                <div class="profile">
                    @if(auth()->user()->image == null)
                        <img src="{{asset('public/dashboard/imgs/elliot.webp')}}" alt="profile picture" />
                    @else
